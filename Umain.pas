...
begin
  ...
  Edit_TeoreticLength.Text := FloatToStr(temporaryRoundResultValue);

  levelQualityOfProgram := (digitTwo*StrToInt(Edit_UniqueOperand.Text))/(StrToInt(Edit_UniqueOperator.Text)*StrToInt(Edit_AllOperand.Text));
  temporaryRoundResultValue := RoundTo(levelQualityOfProgram, -digitThree);
  EditLevelOfQuality.Text := FloatToStr(temporaryRoundResultValue);
  ...
  Edit_TeoreticVolume.Text := FloatToStr(temporaryRoundResultValue);
  ...
  Edit_ComplexityUnderstanding.Text := FloatToStr(temporaryRoundResultValue);

  complexityOfCoding := 1 / levelQualityOfProgram;
  temporaryRoundResultValue := RoundTo(complexityOfCoding, -digitThree);
  Edit_ComplexityOfCoding.Text := FloatToStr(temporaryRoundResultValue);
  ...
  Edit_InformationContent.Text := FloatToStr(temporaryRoundResultValue);
  ...
  Edit_IntellectualEfforts.Text := FloatToStr(temporaryRoundResultValue);
end;
